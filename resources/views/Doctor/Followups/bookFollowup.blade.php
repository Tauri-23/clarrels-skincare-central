...
<body class="bg-white2">
    ...
    {{-- Navs --}}
    {{-- Navs --}}
    <x-top_nav_doctor title="Patient | {{$patient->firstname}} {{$patient->middlename}} {{$patient->lastname}} | Follow-up Appointment" :doctor="$doctor"/>
    ...
    <div class="content-1 compressed d-flex flex-direction-y gap1">
        ...
        <div class="long-cont d-flex gap3 align-items-center">
            <a href="/DoctorViewPatient/{{$patient->id}}" class="txt-l3 fw-bold text-decoration-none color-black2"><i class="bi bi-chevron-left"></i></a>
            <div class="txt-l3 fw-bold color-black2">Book Follow-up Appointment</div>
        </div>
    ...
    <script src="/assets/js/doctor-book-follow-up.js"></script>
